...
const page = () => {
  ...
  return (
    ...
    //               <p>Switch to {pageDetails.page_name} page as admin to start managing it</p>
    //             </div>
    //             <Link className='switch-btn' href={`/manage-page/${pageDetails.page_user_name}`}>Switch Now</Link>
    //           </div>
    //         </div>
    //         : <></>
    //       }
    ...
    //                           alt="photo" class="image-height" /></a>
    //                       </li>
    //                     ))}
    //                   </ul>
    //                 </div>
    ...
    //             {lastestImage.length == 0 ?
    //               <div className='page-sidebar--nothing-div'>
    //                 <div className='nothing-svg'>
    //                   <svg
    //                     xmlns='http://www.w3.org/2000/svg'
    //                     width='36'
    //                     height='36'
    ...
    //               <div className='page-sidebar-div'>
    //                 <div className='page-sidebar-intro'>
    //                   <h5>Do You recommend {pageDetails.page_name} ?</h5>
    //                   <svg
    //                     xmlns='http://www.w3.org/2000/svg'
    //                     width='16'
    //                     height='16'
    ...
    //                     <button className="recommendation-btn " onClick={(e) => {
    //                       setModal(true)
    //                       setType('Yes')
    //                     }}>Yes</button>
    //                   </div>
    ...
    //             <PageReview pageDetails={pageDetails} />
