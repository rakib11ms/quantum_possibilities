      ...
      <div className="tas_profile_photo_item">
        <div className="tas_profile_photo_edit_container">
          <span className="tas_profile_photo_edit_span_container">
            ...
            >
              <path
                d="M3 12C3 13.1 3.9 14 5 14C6.1 14 7 13.1 7 12C7 10.9 6.1 10 5 10C3.9 10 3 10.9 3 12ZM17 12C17 13.1 17.9 14 19 14C20.1 14 21 13.1 21 12C21 10.9 20.1 10 19 10C17.9 10 17 10.9 17 12ZM10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10C10.9 10 10 10.9 10 12Z"
                fill="#132362"
              />
            </svg>
          </span>
        ...
        <img
          className="tas_profile_photo"
          src={`${host}/uploads/posts/${img}`}
        />
      </div>
    );
  };
  ...
  return (
    <div className="tas_photo_wrapper">
      <div className="d-flex justify-content-between align-items-center">
        <span className="tas_all_photo_grid_title">Page Photos</span>
      ...
      <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div className="prof-ful-work-edu-div">
          <div className="prof-work-edu-div">
            ...
            >
              <h6 className="about-profile-bartext">Page Photo</h6>
            </div>
            <div
