        ...
        <>
            <div className="">
                ...
                <div class="reels-main-page-wrapper" style={{ marginTop: '78px' }}>
                    <div class={` ${fullViewTrigger ? "full-width" : "reels-left-sec"}`}>
                        ...
                        <div class="reels-left-sec-wrapper">
                            <div class="video-main-wrapper">
                                ...
                                <div class="inside-video-bottom-description-overlay">
                                    <p
                                        className="p-1"
                                ...
                                <div class="video-indicator-wrapper">

                                    <div class="left-indicator" style={{ color: "white" }}>

                                        {/* {(currentReelIndex > 0 && allReels.length > 1) && ( */}

                                        <div className="rounded " onClick={handlePrevButton} style={{ color: "wheat" }}>
                                    ...
                                    <div class="right-indicators">
                                        <div class="">
                                            ...
                                            {(currentReelIndex < totalReels - 1 && allReels.length > 1) && (
                                                <>
                                                    ...
                                                    <div className="rounded " onClick={handleNextButton} style={{ color: "wheat" }}>
                                        ...
                                        <div class="" >
                                            ...
                                            >
                                                {
                                                    reelsPostComments[0]?.user_id._id === reelsPostComments[0]?.userReelId?.user_id && <FontAwesomeIcon
                                                        icon={faThumbsUp}
                                                        style={{
                                                            fontSize: "22px",
                                                            cursor: "pointer",
                    ...
                    <div class={` border bg-white p-2 ${fullViewTrigger ? "normal-width" : "reels-right-sec"}`}>
