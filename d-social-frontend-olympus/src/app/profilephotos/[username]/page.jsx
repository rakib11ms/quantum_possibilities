...
const Page = () => {
  ...
  useEffect(() => {
    ...
    axiosInstance.post("/api/get-users-latest-image", formData).then((res) => {
      if (res.data.status == 200) {
        setPhotoList(res.data.posts);
      }
    });
  }, []);
      ...
      <Masterdashboardlayout headerName='Photos'>
        <div>
          <div className='profile-phot-header-div'>
            <ProfileHeader active={"profilephotos"} />
          </div>
              ...
              <div>
                <div className='photos'>
                  <div className='tab-pro-photo-header'>
                    ...
                    {/* <div
                      className={`tab-pro-photo ${activeTab === 2 ? "active-tab-pro-photo" : ""
                        }`}
                    ...
                    {activeTab === 1 && (
                      <div className='photo-grid'>
                        {photoList.map((src, index) => (
                          <Link href={`/view-single-post/${src.post_id}`}>
