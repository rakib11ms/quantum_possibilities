...
const PostListCopyDontTouch = () => {
  ...
  console.log(sharePost, "sjare post");
  ...
  const saveSharePost = (post_id) => {
    ...
    axiosInstance
      .post("/api/save-share-post-with-caption", formData)
      .then((res) => {
        if (res.data.status == 200) {
          toast.success(res.data.message, {
            position: "top-right",
      ...
      axiosInstance
        ...
        .then((res) => {
          if (res.data.status === 200) {
            ...
            axiosInstance
              .get(`/api/view-single-main-post-with-comments/${postSubmitID}`)
              .then((res) => {
                if (res.data.status === 200) {
                  setCommentTextState({});
                  // setCommentImageOrVideoFile(null);
      ...
      axiosInstance
        ...
        .then((res) => {
          if (res.data.status == 200) {
            ...
            axiosInstance
              .get(
                `/api/view-single-main-post-with-comments/${commentReplyPostId}`
              )
              .then((res) => {
                if (res.data.status === 200) {
                  setCommentTextState("");
  ...
  function getReactionImageSrc(reactionType) {
    switch (reactionType) {
      ...
      case "care":
        return `${host}/assets/reactions/care.gif`;
      case "wow":
  ...
  async function getEditMainCommentData() {
    axiosInstance
      .get(
        `/api/edit-comment-by-direct-post/${editMainCommentPostId}/${editMainCommentId}/main_comment`
      )
      .then((res) => {
        if (res.data.status == 200) {
  ...
  async function getEditMainCommentReplyData() {
    axiosInstance
      .get(
        `/api/edit-comment-by-direct-post/${editMainCommentPostId}/${editMainCommentReplyId}/reply_comment`
      )
      .then((res) => {
        if (res.data.status == 200) {
  ...
  const handleCommentReactionSubmit = (
    ...
    axiosInstance
      .post("api/save-comment-reaction-of-direct-post", commentReactionData)
      .then((res) => {
        if (res.data.status == 200) {
          setRenderComments(res.data);
          toast.success(res.data.message, {
          ...
          axiosInstance
            .get(
              `/api/view-single-main-post-with-comments/${commentReactionPostID}`
            )
            .then((res) => {
              if (res.data.status === 200) {
                setCommentTextState("");
  ...
  return (
    <div className='ui-block posts-full-div '>
      {
        // allPosts !== undefined && postLoading === true ? (
        //     <>
        ...
        //         </div>
        //         <div className="post-skeleton mt-2">
        //             <Skeleton height={16} width={100} style={{ marginBottom: "8px" }} />
        //             <Skeleton height={80} style={{ marginBottom: "16px" }} />
        //             <Skeleton height={16} width={50} />
        //         </div>
        ...
        allPosts.map((item, i) => {
          ...
          return (
            <article className='hentry post video  ' key={i}>
              <div className='post__author author vcard inline-items'>
                ...
                {item.user_id.profile_pic !== null ? (
                  <div className='author-thumbs'>
                    <div className='more'>
                      ...
                      /> */}
                        {/* <ul className='more-dropdown-auth-post'>
                        <div>
                          <div className='post-auth-hover-div'>
                            <div className='avatar-post-hover'>
                              {
                                item.page_id != null ?
                                  <img
                                    src={`${host}/uploads/pages/${item.page_id?.profile_pic}`}
                            ...
                            <div className='post-text-hover-div'>
                              {
                                item.page_id != null ?
                                  <h4 className='post-text-hove-tag'>
                              ...
                              <div className='post-hover-icon-text-div'>
                                <Image
                                  src={postHovericontwo}
                                  width={30}
                                  height={30}
                                  alt=''
                                />

                                <p className='post-hover-text'>
                                  <strong>member</strong> at Bangladesh Film
                                  Directors Association and member at Directors
                                  Guild-Bd
                                </p>
                              </div>
                              <div className='post-hover-icon-text-div'>
                                ...
                                <p className='post-hover-text'>
                                  <strong>Studied</strong> at Tongi Govt.
                                  College, Gazipur.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className='post-hover-btn-div'>
                            <button className='post-hover-btn'>
                              Following
                            </button>
                            <button className='post-hover-Message-btn'>
                              Message
                            </button>
                            <button className='post-hover-svg-btn'>
                              <svg
                                xmlns='http://www.w3.org/2000/svg'
                                width='16'
                                height='16'
                            ...
                            <button className='post-hover-three-btn'>
                              <svg
                                xmlns='http://www.w3.org/2000/svg'
                                width='16'
                                height='16'
                ...
                <div className='author-date-time'>
                  ...
                  {item.post_type == "Shared" ? (
                    <span className='mx-1 fw-400'>has shared a post</span>
                  ) : (
                    ""
                  )}
                    ...
                    <div
                      ...
                      <FormControl
                        ...
                        <Select
                          ...
                          onChange={(e) =>
                            handlePostPrivacyChange(item._id, e.target.value)
                          }
                          // label="Privacy"
                          // onChange={(e) => handlePostPrivacyChange(item._id, e.target.value)}
                          style={{
                            fontSize: "12px",
                            backgroundColor: "tranparency",
              ...
              {item.post_background_color == "null" ||
              item.post_background_color == null ? (
                <div className=''>
                    ...
                    <a href={item.link}>
                      <div className='row thumbnail-div'>
                        <div className='col-md-6'>
                          <img className='thumb-img' src={item.link_image} />
                        </div>
              ...
              {item.post_type == "Shared" ? (
                <div className='pst-img-full-div'>
                  <div>
                    {item?.shareMedia?.length !== undefined &&
                  ...
                  <div className='post-img-auth-img-div'>
                    <div className='id-img-name-div'>
                      ...
                      <div className='modal-min-text-div'>
                        <Link
                          href={`profile/${item.share_post_id?.user_id?.username}`}>
                          <h5>
                            {item?.share_post_id?.user_id?.first_name}{" "}
                            {item?.share_post_id?.user_id?.last_name}
                          </h5>
                        </Link>
                        <p className='modal-min-text'>
                          {formatDate(item?.share_post_id?.createdAt)}
                        </p>
                      </div>
                    </div>
                    ...
                    <div>
                      <p
                        className='post-p-text'
                        dangerouslySetInnerHTML={{
                          __html: item.share_post_id.description,
                        }}
                      />
                    </div>
                  </div>
              ...
              <div className='reaction-count '>
                <div
                  ...
                  <div className=''>
                    <img src='/logo/like.png' className='post-rect-imoji' />
                  </div>

                  <div className='px-0'>
                    <img src='/logo/love.png' className='post-rect-imoji-lve' />
                  </div>
              ...
              <div className='reaction-container  my-0 '>
                {isHovered && (
                  <div
                    className='d-flex '
                    onMouseEnter={() => {
                    ...
                    <figure
                      ...
                      />
                        <img
                        className='care-reacti'
                        src={`${host}/assets/reactions/care.gif`}
                        onClick={() => {
                          setPostReactionCurrentType("care");
                        }}
                        alt='Care emoji'
                      />
                      <img
                ...
                <div
                  ...
                  <div className=''>
                    ...
                    <ul
                      className={`dropdown-menu abt-drops ${
                        isDropdownOpenArray[i] ? "show" : ""
                      }`}
                      ...
                      <div className='share-modal-full-div'>
                        <div className='row share-modal-header'>
                          ...
                          <div className='col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4'>
                            <span className='share-modal-tages'>
                              Share post
                            </span>
                          </div>
                          <div className='col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4'>
                        ...
                        <div className='id-img-name-full-div'>
                          ...
                          <div className='pst-img-full-div'>
                            <div>
                              {sharePost?.media?.length !== undefined &&
                            ...
                            <div className='post-img-auth-img-div'>
                              <div className='id-img-name-div'>
                                ...
                                <div className='modal-min-text-div'>
                                  <h5>
                                    {sharePost?.user_id?.first_name}{" "}
                                    {sharePost?.user_id?.last_name}
                                  </h5>
                                  <p className='modal-min-text'>
                                    {formatDate(sharePost?.createdAt)}
                                  </p>
                                </div>
                              </div>
              ...
              <div className='comment-section py-2  '>
                <div
                  ...
                  {item.comments.map((commentitem, commentIndex) => {
                    return (
                      <div
                        className='main-comment-wrapper  py-1 px-2   '
                        scrollstyleReply>
                        ...
                        <div className='main-comment-text'>
                          <div className='comment-name-dateZone'>
                            <Link
                          ...
                          {editMainCommentId !== commentitem._id && (
                            <>
                              <div className='comment-txt '>
                                ...
                                {commentitem.link_image != null &&
                                  commentitem.link_image != "" && (
                                    <a href={commentitem.link}>
                                      <div className='row thumbnail-div'>
                                        <div className='col-md-4'>
                                          <img
                                            src={commentitem.link_image}
                                            width='70px'
                                          />
                                        </div>
                                        <div className='col-md-8 thumbnail-div-content'>
                                          <p>{commentitem.link_title}</p>
                                        </div>
                                      </div>
                                    </a>
                                  )}
                            ...
                            editMainCommentId == commentitem._id && (
                              <div className=''>
                                <textarea
                                  ...
                                  value={editCommentData}></textarea>
                                <span
                                  href=''
                            ...
                            {commentitem.replies.length > 0 &&
                              commentitem.replies.map(
                                (replyComment, replyIndex) => {
                                  return (
                                    <div
                                      className='main-comment-reply-div-wrapper rounded-right py-1 px-2'
                                      ...
                                      <div className='main-comment-text rounded'>
                                        ...
                                        {editMainCommentReplyId !==
                                          ...
                                          <div className='comment-txt'>
                                            ...
                                            {replyComment.link_image != null &&
                                              replyComment.link_image != "" && (
                                                <a href={replyComment.link}>
                                                  <div className='row thumbnail-div'>
                                                    <div className='col-md-4'>
                                                      <img
                                                        src={
...
export default PostListCopyDontTouch;
