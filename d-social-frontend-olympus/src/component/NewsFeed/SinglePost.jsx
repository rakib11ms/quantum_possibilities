...
const SinglePost = () => {
    ...
    async function allPostss() {
        ...
        axiosInstance.post("/api/get-single-post", formData).then((res) => {
    ...
    const shareToPublic = (post_id) => {
        ...
        axiosInstance.post('/api/save-share-post', {
    ...
    function openWhoesReactOnCommentModal(
        ...
        axiosInstance
            .get(
                `/api/reaction-user-lists-comments-of-a-direct-post/${reactionPostId}/${commentId}/${commentRepliesId || "null"
                }`
            )
            .then((res) => {
                if (res.data.status == 200) {
                    ...
                    <article className='hentry post video  ' key={i}>
                        <div className='post__author author vcard inline-items'>
                            ...
                            <div className='author-date'>
                                ...
                                <div className='d-flex align-items-center author-date-custom-margin'>
                                    ...
                                    <div
                                        ...
                                        className='mx-2 '
                                        class={
                                            item.user_id._id !== userId ? "post-privacy-trigger" : ""
                                        }>
                                        <FormControl
                                            size='small'
                                            fullWidth
                        ...
                        <div className='comment-section py-2  '>
                            <div
                                className={`comment-section-wrapper bg-white ${item.comments.length > 1
                                    ? "comment-scrollbar"
                                    ...
                                    <div className='w-100 main-comment-div '>
                                        ...
                                        <div className='comments-icons d-flex px-1'>
                                            ...
                                            {commentImageOrVideoFile && (
                                                <div
                                                    className='mx-2 '
                                                    onClick={submitMainCommentWithImageOrVideo}>
                                                    <FontAwesomeIcon
                                                        icon={faPaperPlane}
                                                        className='mx-1'
                                            ...
                                            postid == item._id && (
                                                <div className='comment-image-or-video-portion-render'>
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() => setCommentImageOrVideoFile(null)}>
                                                        X
                                                    </div>

                                                    {commentImageOrVideoFile &&
                                                        commentImageOrVideoFile.type.startsWith(
                                                            "image/"
                                                        ) && (
                                                            <img
                                    ...
                                    return (
                                                    ...
                                                    : editMainCommentId !== commentitem._id && (
                                                        <>
                                                            ...
                                                            {commentitem.image_or_video !== null && (
                                                                <div
                                                                    className='view-comment-image-video-image mt-1'
                                                                    key={commentitem.image_or_video}>
                                                                    {commentitem.image_or_video.endsWith(
                                                                        ".jpg"
                                                                    ) ||
                                                                        commentitem.image_or_video.endsWith(
                                                                            ".jpeg"
                                                            ...
                                                            {editcommentImageOrVideoFile &&
                                                                ...
                                                                <div className='comment-image-or-video-portion-render'>
                                                                    <div
                                                                        className='cross-icon-comment-or-video'
                                                                        onClick={() =>
                                                                            setEditCommentImageOrVideoFile(null)
                                                                        }>
                                                                        X
                                                                    </div>

                                                                    {editcommentImageOrVideoFile &&
                                                                        editcommentImageOrVideoFile.type.startsWith(
                                                                            "image/"
                                                                        ) ? (
                                                                        <img
                                                                            src={URL.createObjectURL(
                                                                    ...
                                                                    <div className='view-comment-image-video-imagessss comment-image-or-video-portion-render'>
                                                                        ...
                                                                        {editCommentImageOrVideo &&
                                                                            (editCommentImageOrVideo.endsWith(".jpg") ||
                                                                                editCommentImageOrVideo.endsWith(
                                                                                    ".jpeg"
                                                                                ) ||
                                                                                editCommentImageOrVideo.endsWith(
                                                                                    ".png"
                                                                            ...
                                                                            <img
                                                                                src={`${host}/${editCommentImageOrVideo}`}
                                                                                alt='Comment Image'
                                                                            />
                                                                        ) : editCommentImageOrVideo &&
                                                                            (editCommentImageOrVideo.endsWith(
                                                                ...
                                                                <div className='comments-icons d-flex px-1'>
                                                                    ...
                                                                    {commentReplyImageOrVideoFile && (
                                                                        <div
                                                                            className='mx-2 '
                                                                            onClick={
                                                                                submitMainCommentReplyWithImageOrVideo
                                                                            }>
                                                                            {/* Add */}
                                                                    ...
                                                                    commentitem._id == commentid && (
                                                                        <div className='comment-image-or-video-portion-render'>
                                                                            ...
                                                                            <div
                                                                                className='cross-icon-comment-or-video'
                                                                                onClick={() =>
                                                                                    setCommentReplyImageOrVideoFile(
                                                                                        null
                                                                                    )
                                                                                }>
                                                                                X
                                                                            ...
                                                                            {commentReplyImageOrVideoFile &&
                                                                                item._id == postid &&
                                                                                commentitem._id == commentid &&
                                                                                commentReplyImageOrVideoFile.type.startsWith(
                                                                                    "image/"
                                                                                ) ? (
                                                                                <img
                                                                                    src={URL.createObjectURL(
                                                                                ...
                                                                                <video controls>
                                                                                    <source
                                                                                        ...
                                                                                        type={
                                                                                            commentReplyImageOrVideoFile.type
                                                                                        }
                                                                                    />
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img
                                                                            ...
                                                                            src={`${host}/uploads/${replyComment.replies_user_id &&
                                                                                replyComment.replies_user_id.profile_pic
                                                                                }`}
                                                                            alt=''
                                                                        />
                                                                        {/* </div> */}
                                                                        <div className='main-comment-text rounded'>
                                                                            ...
                                                                            {editMainCommentReplyId !==
                                                                                replyComment._id && (
                                                                                    <>
                                                                                        ...
                                                                                        {replyComment.image_or_video !==
                                                                                            null && (
                                                                                                <div className='view-comment-image-video-image mt-1'>
                                                                                                    {replyComment.image_or_video.endsWith(
                                                                                                        ".jpg"
                                                                                                    ) ||
                                                                                                        replyComment.image_or_video.endsWith(
                                                                                                            ".jpeg"
                                                                                        ...
                                                                                        <div className='comments-icons d-flex px-1 '>
                                                                                            <div className=''>
                                                                                                ...
                                                                                                <input
                                                                                                    ...
                                                                                                    type='file'
                                                                                                    onChange={(e) => {
                                                                                                        handleEditReplyCommentImageVideo(
                                                                                                            e,
                                                                                                            item._id,
                                                                                                            "reply_comment"
                                                                                                        );
                                                                            ...
                                                                            {editReplyCommentImageOrVideo &&
                                                                                ...
                                                                                <div className='comment-image-or-video-portion-render'>
                                                                                    ...
                                                                                    {editReplyCommentImageOrVideoFile &&
                                                                                        editReplyCommentImageOrVideoFile.type.startsWith(
                                                                                            "image/"
                                                                                        ) ? (
                                                                                        <img
                                                                                            src={URL.createObjectURL(
                                                                                        ...
                                                                                        <video controls>
                                                                                            <source
                                                                                                ...
                                                                                                type={
                                                                                                    editReplyCommentImageOrVideoFile.type
                                                                                                }
                                                                                            />
                                                                                            Your browser does not support the
                                                                                            video tag.
                                                                                ...
                                                                                null && (
                                                                                    <div className='view-comment-image-video-imagessss comment-image-or-video-portion-render'>
                                                                                                ...
                                                                                                axiosInstance
                                                                                                    ...
                                                                                                    .then((res) => {
                                                                                                        if (
                                                                                                            ...
                                                                                                            setEditMainCommentId(
                                                                                                                null
                                                                                                            );
                                                                                                            setEditMainCommentStatus(
                                                                                                                false
                                                                                                            );
                                                                                                            toast.success(
                                                                                                                "Comment Updated successfully",
                                                                                        ...
                                                                                        {editReplyCommentImageOrVideo &&
                                                                                            (editReplyCommentImageOrVideo.endsWith(
                                                                                                ".jpg"
                                                                                            ) ||
                                                                                                editReplyCommentImageOrVideo.endsWith(
                                                                                                    ".jpeg"
                                      ...
                                      /> */}
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    {replyComment
                                                                                        .replies_comment_reactions.length >
                                                                                        0 && (
                                                                                            <div className='mt-1 text-muted'>
