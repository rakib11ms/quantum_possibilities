...
export default function PostPhotoOnly({ postInformation, setIsPostDetailsModalOpen, setSelectedImageIndex }) {
                        ...
                        {postInformation?.media?.map((media, index) => {
                           ...
                           if (allImgageType.includes(fileType)) {
                              return (
                                 <img
                                    onClick={() => {
                                       setIsPostDetailsModalOpen((prev) => ({
                                          post_id: postInformation.post_id,
                                          postDetailsModalOpen: !prev?.isPostDetailsModalOpen,
                                       }));
                              ...
                              return (
                                 <video
                                    ...
                                    controls
                                 >
                                    <source src={`${host}/uploads/posts/${media.media}`} type={`video/${fileType}`} />
