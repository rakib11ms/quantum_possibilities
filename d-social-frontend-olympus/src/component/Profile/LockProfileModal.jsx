...
function LockProfileModal({ isOpen, onRequestClose, setLockProfile, lockState }) {
  const customStyles = {
    overlay: {
      zIndex: 1001,
  ...
  const handleLockProfile = () => {
    axiosInstance.post('/api/lock-profile').then((res) => {
    ...
    <Modal isOpen={isOpen}
      ...
      <div className="modal-content">
        ...
        <h2 className='text-center lock-modal-header'>
          ...
          </svg>Lock your profile</h2>


        <p className='text-center'>Make you photos and posts more private in one step.</p>
          ...
          <ul className="notification-list privacy-list">
            <li>
              <div style={{ display: 'flex' }}>
                ...
                <div className="notification-event">
                  Only friends will see the photos, posts and stories on your profile
            ...
            <li>
              <div style={{ display: 'flex' }}>
                ...
                <div className="notification-event">
                  People will still be able to search for you and send you friend requests
                </div>
              </div>
            </li>
        ...
        <button className='post-btton' onClick={handleLockProfile}>Lock Profile</button>
      </div>
    </Modal>
  )
}
