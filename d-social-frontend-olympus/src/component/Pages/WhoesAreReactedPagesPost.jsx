...
function WhoesAreReactedPagesPost(props) {
    ...
    return (
        <Modal
            ...
            <div className='whoes-react border-bottom'>
                ...
                >
                    <Tab
                        label={`ALL (${props.reactedUserListsOfDirectPosts && props.
                            reactedUserListsOfDirectPosts.length
                            })`}></Tab>
                    ...
                    <Tab
                        label={
                            <>
                                ...
                                <span>
                                    {
                                        props.reactedUserListsOfDirectPosts.filter(
            ...
            <div className='whoes-reactions-content'>
                <div
                    ...
                    {props.reactedUserListsOfDirectPosts.map(
                            ...
                            return (
                                <div
                                    ...
                                    <div className='whoes-post-reactions-persons-info'>
                                        <div className=''>{reactionItem.user_id.first_name}</div>
                                        {/* <div className=''>
                                                Software Engineer1
                                            </div> */}
                                    </div>
                ...
                <div
                    ...
                    {props.reactedUserListsOfDirectPosts
...
export default WhoesAreReactedPagesPost