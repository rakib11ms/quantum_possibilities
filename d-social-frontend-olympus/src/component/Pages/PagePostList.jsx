...
const PagePostList = ({ pageDetails }) => {
   ...
   async function allPostss(page_id) {
      const formData = {
         page_id: page_id,
      };
      console.log({ formData });
      axiosInstance.post('/api/get-pages-posts', formData).then((res) => {
         ...
         axiosInstance
            ...
            .then((res) => {
               if (res.data.status == 200) {
                  ...
                  axiosInstance
                     .get(`/api/view-single-main-post-with-comments/${commentReplyPostId}`)
                     .then((res) => {
                        if (res.data.status === 200) {
                           setCommentTextState('');
                           const postIndex = allPosts.findIndex(
   ...
   useEffect(() => {
      if (clicktoSeeWhoReactedPostId) {
         axiosInstance
            .get(`/api/reaction-user-lists-of-direct-post/${clicktoSeeWhoReactedPostId}`)
            .then((res) => {
               if (res.data.status == 200) {
      ...
      axiosInstance
         ...
         .then((res) => {
            if (res.data.status == 200) {
               ...
               axiosInstance
                  .get(`/api/view-single-main-post-with-comments/${commentReactionPostID}`)
                  .then((res) => {
                     if (res.data.status === 200) {
                        setCommentTextState('');
      ...
      <div className="ui-block posts-full-div ">
         {allPosts.map((item, i) => {
            ...
            const userHasReacted =
               ...
               allMainPostReactions.some((reaction) => reaction.post_id === item._id);
            return (
                           ...
                           >
                              ...
                              >
                                 ...
                                 <Select
                                    ...
                                    value={
                                       selectedOption.find((option) => option.id === item._id)
                                          ?.post_privacy || 'public'
                                    }
                                    onChange={(e) =>
                              ...
                              >
                                 ...
                                 <div className="main-comment-text">
                                          ...
                                          item.user_id._id === userId ? (
                                             <svg
                                                ...
                                                onClick={() => {
                                                   ...
                                                   axiosInstance
                                                      .post('/api/delete-single-comment', formData)
                                                      .then((res) => {
                                                         allPostss();
                                                         toast.success(
                                    ...
                                    {commentitem.replies.length > 0 && (
                                       <a
                                          className={`${viewMoreRepliesLogicCommentId === commentitem._id && viewMoreRepliesLogicPostId === item._id ? 'd-none' : ''}`}
                                       ...
                                       commentReplyTextRender &&
                                          commentIdReplyId == commentitem._id && (
                                             ...
                                             >
                                                ...
                                                <div className="w-100 main-comment-div ">
                                                   <form
                                                      onSubmit={(e) => handleCommentReplySubmit(e)}
                                                   >
                                                      <textarea
                                                         aria-label="empty textarea"
                                                         placeholder="Type your comment..."
