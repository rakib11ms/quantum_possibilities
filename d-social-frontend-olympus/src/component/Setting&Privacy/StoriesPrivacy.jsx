...
export default function StoriesPrivacy() {
    const { showNotification } = useToaster()
    const [prevData, setPrevData] = useState(null)

    const getUserPostPrivacy = () => {
        setPrevData(null)
        axiosInstance.get(`/api/settings-privacy/get-post-privacy?post_type=story`)
    ...
    return (
        ...
        <div className="ui-block">
            <div className="ui-block-title " style={{ border: 0 }}>
                <h6 className="title" style={{ textAlign: 'start', borderBottom: '0px' }}>Stories Privacy</h6>
            </div>
