...
const GroupRightSidebarMessenger = () => {
    ...
    const [activeAccordion4, setActiveAccordion4] = React.useState(null);
    const isAccordionExpanded4 = (accordionId4) => {
        return activeAccordion4 === accordionId4;
    };
    const handleAccordionClicks4 = (accordionId4) => {
        setActiveAccordion4((prevAccordion4) =>
            prevAccordion4 === accordionId4 ? null : accordionId4
        );
    };
        ...
        <div className='tas_right_side_full_div'>
            <div className='right-side-div'>
                <div className='tas_mssengridimg_div'>
                    ...
                    <img className='mssengridimg' src={`${host}/uploads/messenger/${groupInfo.group_image}`} alt='' />
                    {/* <img className='tas_mssengridimg' src={`${host}/uploads/1706331352375-download.jpg`} alt='' /> */}

                </div>
                <div className='tas_user_name_container'>
                    <span className='tas_user_name'>{groupInfo.group_name}</span>
                    ...
                    <div className='accordion' id='accordionExample'>
                        <div className='accordion-item' style={{ border: "none" }}>
                            <div className='accor-tag-div'>
                                {/* <h6 className='accordion-header'> */}
                                <div
                                    className={`accordion-button w-100 ${isAccordionExpanded4(`collapse`) ? "" : "collapsed"
                                        }`}
                                    type='button'
                                    data-bs-target={`#collapse`}
                                    aria-expanded={isAccordionExpanded4(`collapse`)}
                                    aria-controls={`collapse`}
                                    onClick={() => handleAccordionClicks4(`collapse`)}>
                                    <div className='ccsc'>
                                        <span className='tas_right_dropdown_title'>Members</span>
                                        <svg
                                            xmlns='http://www.w3.org/2000/svg'
                                            width='14'
                                            height='9'
                                            viewBox='0 0 14 9'
                                            fill='none'
                                            className={`accordion-chevron-svg ${isAccordionExpanded4(`collapse`) ? "expanded" : ""
                                                }`}>
                                            <path
                                                d='M7 5.44484L12.4447 -6.79848e-08L14 1.55536L7 8.55556L-6.79867e-08 1.55535L1.55531 -5.43975e-07L7 5.44484Z'
                                                fill='#001835'
                            ...
                            <div
                                id={`collapse`}
                                className={`accordion-collapse collapse ${isAccordionExpanded4(`collapse`) ? "show" : ""
                                    }`}
                                data-bs-parent='#accordionExample'>
                                <div className='accordion-body'>
                                    {groupInfo?.members?.map(item => {
                                        return <Link href={`/${item.username}/timeline`}>
                                            <span className='tas_chat_setting'>
                                                <p className="tas_chat_setting_text">{item.first_name} {item.last_name}</p>
                                            </span>
                                        </Link>
                                    })}
                                </div>
...
export default GroupRightSidebarMessenger;
