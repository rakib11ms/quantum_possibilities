...
function ShareModal({ isOpen, onRequestClose, group_id }) {
    const customStyles = {
        overlay: {
            zIndex: 1001,
    ...
    const copyToClipboard = () => {
        const inputValue = frontendHost + '/groupsinglePreview/' + group_id;
            ...
            <div className="modal-content">
                ...
                <div className='p-3'>
                    <ul className="notification-list privacy-list">
                        <li>
                            <input type="text" value={`${frontendHost}/groupsinglePreview/${group_id}`} readOnly />
                        </li>
